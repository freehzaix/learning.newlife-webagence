                    ...
                    <div class="breadcrumbs-inner">
                        <div class="container">
                            <div class="breadcrumbs-text">
                                <h1 class="breadcrumbs-title">Courses Grid</h1>
                                <div class="back-nav">
                                    <ul>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                                ...
                                <div class="col-lg-6">
                                    <div class="course__item mb-30">
                                        ...
                                        <div class="course__inner">
                                            ...
                                            <h3 class="back-course-title"><a href="coureses-single.html">Become a
                                                    product <br> Manager learn the skills & job.</a></h3>
                                ...
                                <div class="col-lg-6">
                                    <div class="course__item mb-30">
                                        ...
                                        <div class="course__inner">
                                            ...
                                            <h3 class="back-course-title"><a href="coureses-single.html">Learning to
                                                    write as a <br>Professional.</a></h3>
                                            <div class="course__card-icon d-flex align-items-center">
                                                <div class="course__card-icon--1">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                        height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <div class="col-lg-6">
                                    <div class="course__item mb-30">
                                        ...
                                        <div class="course__inner">
                                            ...
                                            <h3 class="back-course-title"><a href="coureses-single.html">Academic
                                                    Listening and <br> Note taking.</a></h3>
                                            <div class="course__card-icon d-flex align-items-center">
                                                <div class="course__card-icon--1">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                        height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <div class="col-lg-6">
                                    <div class="course__item mb-30">
                                        ...
                                        <div class="course__inner">
                                            ...
                                            <h3 class="back-course-title"><a href="coureses-single.html">Master Query
                                                    in a Short<br> Period of Time.</a></h3>
                                            <div class="course__card-icon d-flex align-items-center">
                                                <div class="course__card-icon--1">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                        height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <div class="col-lg-6">
                                    <div class="course__item mb-30">
                                        ...
                                        <div class="course__inner">
                                            ...
                                            <h3 class="back-course-title"><a href="coureses-single.html">Personal
                                                    Finance Financial <br>Security Thinking.</a></h3>
                                            <div class="course__card-icon d-flex align-items-center">
                                                <div class="course__card-icon--1">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                        height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <ul class="back-pagination">
                                ...
                                <li><a href="#">2</a></li>
                                <li><a href="#">3</a></li>
                                <li class="back-next"><a href="#">Next<i class="arrow_carrot-right"></i></a>
                                </li>
                            </ul>
                            ...
                            <div class="back-sidebar pl-30 md-pl-0 md-mt-60">
                                <div class="widget back-search">
                                    <form>
                                        ...
                                        <button> <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                height="24" viewBox="0 0 24 24" fill="none"
                                                stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    ...
                                    <ul class="recent-category">
                                        <li>
                                            <input type="checkbox" id="fruit10" name="fruit-10"
                                                value="All Levels">
                                            <label for="fruit10">All Levels <span
                                                    class="category-count">(50)</span></label>
                                        </li>
                                        <li>
                                            <input type="checkbox" id="fruit11" name="fruit-11" value="Beginner">
                                            <label for="fruit11">Beginner <span
                                                    class="category-count">32)</span></label>
                                        </li>
                                        <li>
                                            <input type="checkbox" id="fruit12" name="fruit-12"
                                                value="Intermediate">
                                            <label for="fruit12">Intermediate<span
                                                    class="category-count">(17)</span></label>
                                        </li>
                                        <li>
                                            <input type="checkbox" id="fruit13" name="fruit-13" value="Expert">
                                            <label for="fruit13">Expert<span
                                    ...
                                    <ul class="related-courses">
                                        <li>
                                            <a href="coureses-single.html"><span class="post-images"><img
                                                        src="assets/images/related-course/1.jpg"
                                                        alt="post"></span></a>
                                            <div class="titles">
                                        ...
                                        <li>
                                            <a href="coureses-single.html"><span class="post-images"><img
                                                        src="assets/images/related-course/2.jpg"
                                                        alt="post"></span></a>
                                        ...
                                        <li>
                                            <a href="coureses-single.html"><span class="post-images"><img
                                                        src="assets/images/related-course/3.jpg"
                                                        alt="post"></span></a>
                                            <div class="titles">
                                                <div class="back-ratings">
                                                    <i class="icon_star"></i>
