            ...
            <form action="{{ route('niveau.store') }}" method="POST">
                ...
                <div class="row gy-20">
                    ...
                    <div class="col">
                        <div class="row">
                            <div class="col-sm-12">
                                <label for="courseTitle" class="h5 mb-8 fw-semibold font-heading">Ajouter un niveau</label>
                ...
                <table id="studentTable" class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('niveau.show', $item->id) }}" class="btn btn-info">Modifier</a>
                                <a href="{{ route('niveau.destroy', $item->id) }}" class="btn btn-danger">Supprimer</a>
                            </td>
                        </tr>
